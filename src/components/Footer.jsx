...
function Footer() {
  ...
  return (
    <>
      <footer className="bg-stone-700 flex flex-col sm:flex-row mt-16">
          ...
          <div className="flex list-none gap-9 leading-[3em]">
            <div>
              ...
              <div className="flex  gap-5">
                <li className="text-[1.2em] text-white">contact@culture-clan.com</li>
              </div>
              <div className="flex  gap-6">
                <li className="text-[1.2em] text-white ">254-700-333-333</li>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="icons flex gap-6 ">
              <img
                className="site size-8 bg-white rounded-full"
