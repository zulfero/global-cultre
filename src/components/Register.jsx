...
function Register(){
    ...
    return(
      ...
      <input type="text" placeholder="First Name" className="border-2 px-4 py-3 items-center shadow-xl"/>
      <input type="text" placeholder="Last Name" className="border-2 px-4 py-3 items-center shadow-xl"/>
      </div>
      <input
              type="text"
            ...
            />
      <input type="text" placeholder="Password" className="border  px-[4em] py-6 shadow-xl"/>
    
      <input type="text" placeholder="Cornfirm Password" className="border px-[4em] py-6 shadow-xl "/>
