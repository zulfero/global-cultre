        ...
        <div className="flex justify-around py-9">
          ...
          <div className="h-[60vh] w-[400px] bg-stone-200 border rounded-3xl shadow-lg">
            <h4 className="text-center text-2xl font-bold mt-6">
              Axix Africa Expendition & safaris
            </h4>
            <div className="">
              <div className="flex justify-center mt-10">
                <img
                  src="src/images/Screenshot from 2024-04-24 19-43-00.png"
              ...
              <div className="flex justify-center item-center">
                <button
                  ...
                  className="border-none rounded-[2em] px-[5em] py-5 font-bold bg-stone-600 text-white mt-11"
                >
                  Book Now
                </button>
                {showbookingform ? (
          ...
          <div className="h-[60vh] w-[400px] bg-stone-200 border rounded-3xl shadow-lg">
            ...
            <div className="">
              <div className="flex justify-center mt-10">
                <img
                  src="src/images/Screenshot from 2024-04-24 20-23-45.png"
                  className="rounded-full h-32 w-32"
                  alt="Company 2"
                />
              </div>
          ...
          <div className="h-[60vh] w-[400px] bg-stone-200 border rounded-3xl shadow-lg">
            <h4 className="text-center text-2xl font-bold mt-6">
              Jockey tours and safaris
            </h4>
            <div className="">
              <div className="flex justify-center mt-10">
                <img
                  src="src/images/Screenshot from 2024-04-24 20-21-24.png"
                  className="rounded-full h-32 w-32"
                  alt="Company 3"
                />
              </div>
